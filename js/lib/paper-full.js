	...
	function callEvent(view, type, event, point, target, lastPoint) {
		...
		function call(obj) {
			if (obj.responds(type)) {
				if (!mouseEvent) {
					mouseEvent = new MouseEventPaper(type, event, point, target,
...
var MouseEventPaper = Event.extend({
	_class: 'MouseEventPaper',

	initialize: function MouseEventPaper(type, event, point, target, delta) {
		Event.call(this, event);
		this.type = type;
		this.point = point;
		this.target = target;
